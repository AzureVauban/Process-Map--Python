...
class BlockofNetheritete_unittest(unittest.TestCase): #pylint:disable=C0103
	...
	def test_Netherite_Ingot(self):
		"""assert that Netherite Ingot is equal to 576
		"""

		self.assertEqual(Netherite_Ingot.amountonhand,576)
	def test_Gold_Ingot(self):
		"""assert that Gold Ingot is equal to 2304
		"""

		self.assertEqual(Gold_Ingot.amountonhand,2304)
	def test_Netherite_Scrap(self):
		"""assert that Netherite Scrap is equal to 2304
		"""

		self.assertEqual(Netherite_Scrap.amountonhand,2304)
	def test_Emerald(self):
		"""assert that Emerald is equal to 78336
		"""

		self.assertEqual(Emerald.amountonhand,78336)
